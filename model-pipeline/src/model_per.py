...
class ModelPer(ModelInter):
    ...
    def save_metrics_for_ds(
        ...
        # Predict on the raw training data (or a copy) after adding feature columns if necessary
        # This part assumes df_train_raw might not have all features if they were generated on self.x_train
        # For simplicity, let's assume df_train_raw is x_train and already has necessary columns
        # If df_train_raw is the original raw data, it would need preprocessing steps here or ensure x_train is passed
